...
class TestIdentifyRecurringTransactions(unittest.TestCase):
    ...
    def test_identify_spotify_subscription(self):
        ...
        self.assertTrue(all("Spotify" in t["description"] for t in result))
    ...
    def test_identify_salary_payments(self):
        ...
        self.assertTrue(all("Acme Corp Salary" in t["description"] for t in result))
    ...
    def test_identify_weekly_payments(self):
        ...
        self.assertTrue(all("Weekly Payment" in t["description"] for t in result))
    ...
    def test_mixed_transactions(self):
        ...
        result = identify_recurring_transactions(transactions)
        self.assertEqual(len(result), 4)
        self.assertTrue(all("Recurring" in t["description"] for t in result))
    ...
    def test_group_transactions(self):
        ...
        self.assertEqual(len(groups), 2)  # Spotify and Netflix groups
        self.assertTrue("spotify" in groups)
        self.assertTrue("netflix" in groups)
